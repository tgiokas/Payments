...
WORKDIR /src
COPY ["src/API/Payments.Api.csproj", "src/API/"]
COPY ["src/Application/Payments.Application.csproj", "src/Application/"]
COPY ["src/Domain/Payments.Domain.csproj", "src/Domain/"]

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    jcc_action_code = table.Column<string>(type: "text", nullable: true),
                    jcc_order_status = table.Column<int>(type: "integer", nullable: false),
                    jcc_error_code = table.Column<string>(type: "text", nullable: true),
                    jcc_error_message = table.Column<string>(type: "text", nullable: true),
